...
public class EquipeController {
    ...
    @Operation(summary = "Listar equipes por modalidade")
    public ResponseEntity<List<EquipeResponseDTO>> listarPorModalidade(@PathVariable Long modalidadeId) {
        List<EquipeResponseDTO> equipes = equipeService.listarPorModalidade(modalidadeId);
        return ResponseEntity.ok(equipes);
    }    
